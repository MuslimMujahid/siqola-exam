...
import { useDeleteGroup, useManageGroupMembers } from "@/hooks";
import { useDebounce } from "@/hooks/use-debounce";
import { AddMembersDialog } from "./_components/add-members-dialog";
import { MembersTable } from "./_components/members-table";
import { userRole, UserStatus } from "@/lib/entities/users";
...
export default function GroupDetailPage() {
  ...
  // Delete group
  const { deleteGroup: handleDeleteGroup, isLoading: isLoadingDeleteGroup } =
    useDeleteGroup();
        ...
        <Card className="border-border/50">
          ...
          <CardContent>
            <MembersTable
              ...
              isRemovingMember={isRemovingSingleMember}
